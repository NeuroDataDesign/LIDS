...
def main():
    ...
    graf1 = cv2.imread('input/graf1.png', 1)
    graf2 = cv2.imread('input/graf2.png', 1)
    graf3 = cv2.imread('input/graf3.png', 1)

    leuven1 = cv2.imread('input/leuven1.png', 1)
    leuven2 = cv2.imread('input/leuven2.png', 1)
    leuven3 = cv2.imread('input/leuven3.png', 1)

    wall1 = cv2.imread('input/wall1.png', 1)
    wall2 = cv2.imread('input/wall2.png', 1)
    wall3 = cv2.imread('input/wall3.png', 1)
    ...
    print('\ngraf1, graf2')
    detect(graf1, graf2, './output/graf12features.png', window_size=31, min_ncc=0.5)
    warp(graf1, graf2, './output/graf12sbs.png', './output/graf12stack.png', window_size=31, min_ncc=0.5)

    print('\ngraf1, graf3')
    detect(graf1, graf3, './output/graf13features.png', window_size=21, min_ncc=0.5)
    warp(graf1, graf3, './output/graf13sbs.png', './output/graf13stack.png', window_size=21, min_ncc=0.5)

    print('\nleuven1, leuven2')
    detect(leuven1, leuven2, './output/leuven12features.png', window_size=21, min_ncc=0.5)
    warp(leuven1, leuven2, './output/leuven12sbs.png', './output/leuven12stack.png', window_size=21, min_ncc=0.5)

    print('\nleuven1, leuven3')
    detect(leuven1, leuven3, './output/leuven13features.png', window_size=11)
    warp(leuven1, leuven3, './output/leuven13sbs.png', './output/leuven13stack.png', window_size=11)

    print('\nwall1, wall2')
    detect(wall1, wall2, './output/wall12features.png', window_size=25, min_ncc=0.5)
    warp(wall1, wall2, './output/wall12sbs.png', './output/wall12stack.png', window_size=25, min_ncc=0.5)

    print('\nwall1, wall3')
    detect(wall1, wall3, './output/wall13features.png', window_size=25, min_ncc=0.4)
    warp(wall1, wall3, './output/wall13sbs.png', './output/wall13stack.png', window_size=25, min_ncc=0.4)
